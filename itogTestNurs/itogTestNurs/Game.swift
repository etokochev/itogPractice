...
class Game: Menu {
    ...
    var threeCell: [String] = ["", "", ""]
    
    init(firstCell: [String], secondCell: [String], threeCell: [String]) {
    ...
    func showInfo() {
        print("Первая строчка:\(firstCell)\nВторая строчка:\(secondCell)\nТретья строчка:\(threeCell)")
    }
}
